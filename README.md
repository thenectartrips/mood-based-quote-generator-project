...
- `int` → menu selection & random index  
- `char array` → storing characters and strings  
- `2D char array` → storing multiple quotes  
- `functions` → (`loadQuotes()` & `showRandomQuote()`)
...
- Add a GUI version (Web, Qt, Tkinter, Android)
- Voice assistant / Text-to-Speech mode
- Use online APIs for dynamic quotes
